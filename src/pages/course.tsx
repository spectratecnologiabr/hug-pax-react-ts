...
import videoPlaceholderImg from "../img/course/video-placeholder.svg";
            ...
            <div className="course-container">
                ...
                <div className="course-wrapper">
                    ...
                    <div className="lession-title">
                        <b>Competências Socioemocionais e Projeto de Vida</b>
                    </div>
                    {/* PDF */}
                    <div className="lession-document-wrapper">
                        <div className="pdf-page-wrapper">
                            <Document file={"/Amarelo.pdf"} onLoadSuccess={onDocumentLoadSuccess} onLoadError={console.error} onSourceError={console.error}>
                    ...
                    <div className="lession-media-wrapper active">
                        <div className="video-player-wrapper">
                            <video ref={videoRef} src="/Momentos que Abraçam - EP2.mp4" onLoadedMetadata={(e) => setDuration(e.currentTarget.duration)} onTimeUpdate={(e) => { setCurrentTime(e.currentTarget.currentTime); setProgress((e.currentTarget.currentTime / duration) * 100); }} controlsList="nodownload" />
