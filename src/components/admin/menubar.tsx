...
function Menubar() {
  ...
  return (
    <div className={`admin-menubar admin-menubar-hover-labels ${mobileOpen ? "mobile-open" : ""}`}>
      <div className="admin-menubar-mobile-bar">
        <a href="/admin" className="admin-menubar-mobile-brand" aria-label="Ir para início do painel do administrador">
      ...
      <div className="admin-menubar-shell">
        ...
        <div className="menu-wrapper">
          <a href="/admin" className={pathname === "/admin" ? "menu-link selected" : "menu-link"}>
          ...
          <a href="/admin/courses" className={pathname.includes("/admin/courses") ? "menu-link selected" : "menu-link"}>
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 1.00012H2C1.44772 1.00012 1 1.44784 1 2.00012V16.0001C1 16.5524 1.44772 17.0001 2 17.0001H4C4.55228 17.0001 5 16.5524 5 16.0001V2.00012C5 1.44784 4.55228 1.00012 4 1.00012Z" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 1.00012H6C5.44772 1.00012 5 1.44784 5 2.00012V16.0001C5 16.5524 5.44772 17.0001 6 17.0001H8C8.55228 17.0001 9 16.5524 9 16.0001V2.00012C9 1.44784 8.55228 1.00012 8 1.00012Z" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M1 5.00012H5" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M5 13.0001H9" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M9.80302 1.56016L11.987 1.03016C12.549 0.895165 13.12 1.22016 13.269 1.76216L16.964 15.1802C17.0292 15.4258 17.0003 15.687 16.8831 15.9124C16.7658 16.1379 16.5686 16.3115 16.33 16.3992L16.197 16.4402L14.013 16.9702C13.451 17.1052 12.88 16.7802 12.731 16.2382L9.03602 2.82016C8.97083 2.57451 8.9997 2.31338 9.11697 2.0879C9.23424 1.86242 9.43146 1.68884 9.67002 1.60116L9.80302 1.56016V1.56016Z" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10 6.00012L14 5.00012" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12 13.0001L15.923 12.0201" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ...
          <a href="/admin/logs" className={pathname.includes("/admin/logs") ? "menu-link selected" : "menu-link"}>
            <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 16 16" fill="none">
              <path d="M8 5.33325C11.3137 5.33325 14 4.43782 14 3.33325C14 2.22868 11.3137 1.33325 8 1.33325C4.68629 1.33325 2 2.22868 2 3.33325C2 4.43782 4.68629 5.33325 8 5.33325Z" stroke="#ffffff" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2 3.33325V12.6666C2 13.197 2.63214 13.7057 3.75736 14.0808C4.88258 14.4559 6.4087 14.6666 8 14.6666C9.5913 14.6666 11.1174 14.4559 12.2426 14.0808C13.3679 13.7057 14 13.197 14 12.6666V3.33325" stroke="#ffffff" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2 8C2 8.53043 2.63214 9.03914 3.75736 9.41421C4.88258 9.78929 6.4087 10 8 10C9.5913 10 11.1174 9.78929 12.2426 9.41421C13.3679 9.03914 14 8.53043 14 8" stroke="#ffffff" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span>Logs</span>
          </a>
