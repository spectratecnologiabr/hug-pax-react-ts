    ...
    return (
        <div className="admin-menubar admin-menubar-hover-labels">
            ...
            <div className="menu-wrapper">
                ...
                <a href="/admin/tags" className={pathname.includes("/admin/tags") ? "menu-link selected" : "menu-link"}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.514 2.37201L21.962 5.81901C22.2317 6.08887 22.4187 6.43025 22.5007 6.80288C22.5827 7.1755 22.5565 7.56382 22.425 7.92201L20.662 12.734C20.612 12.8704 20.5328 12.9943 20.43 13.097L12.107 21.42C11.9213 21.6058 11.7008 21.7532 11.4581 21.8538C11.2154 21.9543 10.9552 22.0061 10.6925 22.0061C10.4298 22.0061 10.1697 21.9543 9.92695 21.8538C9.68424 21.7532 9.46373 21.6058 9.278 21.42L2.914 15.056C2.53906 14.681 2.32843 14.1723 2.32843 13.642C2.32843 13.1117 2.53906 12.6031 2.914 12.228L11.247 3.89501C11.35 3.7921 11.4742 3.71292 11.611 3.66301L16.413 1.90801C16.771 1.77708 17.159 1.7512 17.5312 1.83341C17.9034 1.91561 18.2444 2.10248 18.514 2.37201ZM12.505 5.46601L4.328 13.642L10.692 20.006L18.86 11.839L20.547 7.23401L17.1 3.78601L12.505 5.46601ZM15.289 9.04601C15.1433 8.90827 15.0267 8.74272 14.9461 8.55915C14.8655 8.37558 14.8225 8.17771 14.8197 7.97723C14.8168 7.77676 14.8542 7.57775 14.9296 7.39197C15.005 7.2062 15.1169 7.03742 15.2586 6.89561C15.4003 6.75381 15.5691 6.64186 15.7548 6.56638C15.9405 6.4909 16.1395 6.45342 16.34 6.45616C16.5405 6.4589 16.7384 6.50181 16.922 6.58233C17.1056 6.66286 17.2712 6.77938 17.409 6.92501C17.674 7.20936 17.8182 7.58545 17.8114 7.97405C17.8045 8.36266 17.6471 8.73343 17.3722 9.00825C17.0974 9.28308 16.7267 9.4405 16.338 9.44736C15.9494 9.45422 15.5734 9.30997 15.289 9.04501V9.04601Z" fill="#FFFFFF"/>
                    </svg>
